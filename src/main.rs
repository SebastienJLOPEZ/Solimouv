    ...
    vec![
        Jour {
            ...
            ateliers: vec![
                ...
                Atelier { heure: "10:30", titre: "Initiation basketball", association: "Basket Énergie", description: "Dribbles, passes et tirs : atelier encadré pour tous les niveaux.", lieu: "Gymnase", emoji: "🏀", image: "https://images.unsplash.com/photo-1546519638-68e109498ffc?w=150&fit=crop", icon: "accessibility" },
